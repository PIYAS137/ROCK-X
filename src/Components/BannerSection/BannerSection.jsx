...
const BannerSection = () => {
    return (
        <div className="hero rounded-xl overflow-hidden my-10" style={{ backgroundImage: 'url(https://i.ibb.co/SndgNYm/texture-treble-clef-dark-background-isolated-generative-ai.jpg)' }}>
